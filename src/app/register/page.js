...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const goal = form.goal; // add a goal field to your register form, or default to 'farm'
      if (goal === "buy" || goal === "marketplace") {
    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            ChickenPro gives you every tool to plan, manage, and profit from
            your farm — starting today.
          </p>
        ...
        >
          {[
            ...
            <div key={i}>
              <div style={{ fontSize: 22, fontWeight: 800, color: "#6FCF7F" }}>
                {s.value}
              </div>
              <div style={{ fontSize: 11, color: "#3D6B4A", marginTop: 2 }}>
                {s.label}
              </div>
            </div>
          ))}
